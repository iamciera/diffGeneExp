...
dim(itagLength)
astype(itagLength)
is.dataframe(itagLength)

```{r}
library(reshape2)
itagLength.melt <- melt(itagLength)
```
itagLength <- as.data.frame(itagLength)
is.data.frame(itagLength)
head(itagLength)
itagLength.RS <- reshape()


head(itagLength.melt)
